...
export const SEED_PROPERTIES: Property[] = [
  {
    ...
    spaces: [
      { id: genId(), name: 'Living Room', captured: true, verified: true, issues: [] },
      { id: genId(), name: 'Kitchen', captured: true, verified: true, issues: [], thumbnailUrl: propKitchenImg },
      { id: genId(), name: 'Main Bedroom', captured: true, verified: true, issues: [] },
      { id: genId(), name: 'Bedroom 2', captured: true, verified: true, issues: [] },
      { id: genId(), name: 'Bedroom 3', captured: true, verified: true, issues: [] },
      { id: genId(), name: 'Bathroom', captured: true, verified: true, issues: [] },
      { id: genId(), name: 'Balcony', captured: false, verified: false, issues: ['Missing full capture'] },
    ],
    sourceMedia: [],
    timeline: [
      { id: genId(), timestamp: now - 3600000 * 4, event: 'Property detected', type: 'detection' },
      { id: genId(), timestamp: now - 3600000 * 3, event: 'Media check', type: 'analysis' },
      { id: genId(), timestamp: now - 3600000 * 2, event: 'Balcony missing', type: 'error', detail: 'Found balcony missing from media' },
      { id: genId(), timestamp: now - 3600000 * 1, event: 'Capture request sent', type: 'capture_request' },
    ],
  ...
  },
  {
    ...
    spaces: Array(10).fill(null).map((_, i) => ({
      id: genId(), name: `Space ${i + 1}`, captured: true, verified: true, issues: []
    })),
    sourceMedia: [],
    timeline: [
      { id: genId(), timestamp: now - 3600000 * 5, event: 'Property detected', type: 'detection' },
      { id: genId(), timestamp: now - 3600000 * 4, event: 'Media check passed', type: 'analysis' },
      { id: genId(), timestamp: now - 3600000 * 3, event: 'Reconstruction started', type: 'reconstruction' },
    ],
  ...
  },
  {
    ...
    spaces: Array(5).fill(null).map((_, i) => ({
      id: genId(), name: `Room ${i + 1}`, captured: true, verified: true, issues: []
    })),
    sourceMedia: [],
    timeline: [
      { id: genId(), timestamp: now - 86400000, event: 'Verification in progress', type: 'verification' }
    ],
  ...
  },
  {
    ...
    spaces: Array(6).fill(null).map((_, i) => ({
      id: genId(), name: `Area ${i + 1}`, captured: true, verified: true, issues: []
    })),
    sourceMedia: [],
    timeline: [
      { id: genId(), timestamp: now - 86400000 * 2, event: 'Full pipeline complete, awaiting approval', type: 'info' }
    ],
  ...
  },
  {
    ...
    spaces: Array(8).fill(null).map((_, i) => ({
      id: genId(), name: `Zone ${i + 1}`, captured: true, verified: true, issues: []
    })),
    sourceMedia: [],
    timeline: [
      { id: genId(), timestamp: now - 86400000 * 4, event: 'Pipeline complete', type: 'info' },
      { id: genId(), timestamp: now - 86400000 * 3, event: 'Approved', type: 'approval' },
      { id: genId(), timestamp: now - 86400000 * 2, event: 'Published', type: 'publication' }
    ],
