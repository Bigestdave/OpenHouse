...
export function AuthScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-canvas font-sans text-ink">
      ...
      {/* Main Content (Flat layout matching Add Property) */}
      <main className="flex-1 pb-16">
        ...
        <div className="pt-10 pb-8 text-center">
          ...
          <p className="pt-2 text-[15px] text-ink-2 max-w-[600px] mx-auto leading-relaxed">
            {mode === 'signin'
        ...
        <div className="mx-auto max-w-[680px] px-6">
          ...
          <div className="flex justify-center pb-8">
            <div className="inline-flex rounded-xl bg-surface p-1 border border-border shadow-subtle">
              <button
                type="button"
                onClick={() => {
                  setMode('signin')
                ...
                className={`px-6 py-2 text-[14px] font-semibold rounded-lg transition-all ${
                  mode === 'signin'
          ...
          {mode === 'signin' && (
            <div className="pb-8">
              <button
                ...
                disabled={loading}
                className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-surface px-6 py-3.5 text-[15px] font-semibold text-primary shadow-subtle hover:bg-raised-2 transition-all disabled:opacity-50"
              >
              ...
              <div className="relative flex py-6 items-center">
                ...
                <span className="flex-shrink mx-4 text-[12px] font-semibold text-ink-3 uppercase tracking-wider">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 flex items-center justify-end">
              <button
                type="submit"
                disabled={loading}
                className="flex items-center gap-2.5 rounded-lg bg-primary px-8 py-3.5 text-[15px] font-semibold text-text-inverse transition-colors hover:bg-primary-hover disabled:opacity-50 shadow-subtle"
              >
          ...
          {/* Terms Footer */}
          <p className="pt-10 text-center text-[12px] text-ink-3">
      ...
      {/* Footer */}
      <footer className="border-t border-border bg-surface px-8 py-4 text-center text-xs text-ink-3">
