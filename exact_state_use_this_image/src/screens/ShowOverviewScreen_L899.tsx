            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 shadow-subtle">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-[15px] font-bold text-text-primary">Property evidence</h3>
                  <div className="flex items-center gap-4 text-[12.5px] text-text-secondary">
                    <span><strong className="text-text-primary">7</strong> Expected</span>
                    <span><strong className="text-text-primary">7</strong> Captured</span>
                    <span><strong className="text-text-primary">1</strong> Resolved</span>
                  </div>
                </div>
                ...
                <div className="divide-y divide-border/60 text-[13px]">
                  {ROOM_LIST.slice(0, 5).map((room) => (
                    <div key={room.id} className="py-2.5 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="rounded px-2 py-0.5 text-[11.5px] font-semibold bg-success/15 text-success">
                          ✓ Captured
                        </span>
                        <span className="text-[11.5px] text-text-secondary">Phone capture</span>
                      </div>
                    </div>
                  ))}
                  <div className="py-2.5 flex items-center justify-between">
                    <span className="font-medium text-text-primary">Balcony</span>
                    <div className="flex items-center gap-2">
                      <span className="rounded px-2 py-0.5 text-[11.5px] font-semibold bg-success/15 text-success">
                        ✓ Recaptured
                      </span>
                      <span className="text-[11.5px] text-text-secondary">Recapture verified</span>
                    </div>
                  </div>
                </div>
              </div>
