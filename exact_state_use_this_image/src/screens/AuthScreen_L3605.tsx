  ...
  return (
    <div className="min-h-screen bg-canvas antialiased font-sans text-ink selection:bg-primary/20">
      <div className="grid min-h-screen lg:grid-cols-[1fr_1.1fr]">
        ...
        {/* ========================================================================= */}
        <div className="hidden lg:flex relative items-center justify-center overflow-hidden bg-canvas p-8 border-l border-border">
          <div className="relative w-full max-w-[620px] aspect-[16/10] overflow-hidden rounded-2xl border border-border bg-surface shadow-subtle">
            <img
            ...
            />
            {/* Minimal HUD Tag */}
            <div className="absolute top-4 right-4 font-mono text-[10.5px] text-ink-2 bg-canvas/80 backdrop-blur-md px-3 py-1.5 rounded-lg border border-border">
              <div>PROPERTY / OH-00241</div>
              <div>SPACES / 7 · READY</div>
            </div>
          </div>
        </div>
